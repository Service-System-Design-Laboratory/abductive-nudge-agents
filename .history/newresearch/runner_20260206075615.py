...
from newresearch.scenarios import SCENARIOS, PERSONA, get_scenario
...
def run_single(scenario_id: str, condition: str) -> dict:
    ...
    logger.info(f"  Condition: {condition} (PKG={config.use_pkg}, RAG={config.use_rag}, Judge={config.use_judge})")
