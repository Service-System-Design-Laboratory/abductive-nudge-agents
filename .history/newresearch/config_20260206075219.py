...
ABLATION_CONDITIONS = {
    "A": {"use_pkg": True,  "use_rag": True,  "use_judge": True},   # Full
    "B": {"use_pkg": False, "use_rag": True,  "use_judge": True},   # −PKG
    "C": {"use_pkg": True,  "use_rag": False, "use_judge": True},   # −RAG
    "D": {"use_pkg": True,  "use_rag": True,  "use_judge": False},  # −Judge
}
