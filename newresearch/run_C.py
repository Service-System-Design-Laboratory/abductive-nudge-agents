"""
Condition C — −RAG (PKG ✓, RAG ✗, Judge ✓)
Disable external search (RAG/Serper). Generate dialogue with PKG only.

Usage:
    python -m newresearch.run_C                 # All scenarios (S1, S2, S3)
    python -m newresearch.run_C --scenario S1   # Single scenario
"""
...
CONDITION = "C"
CONDITION_LABEL = "−RAG (PKG✓ RAG✗ Judge✓)"
...
def run(scenario_id: str, persona):
    """Run one scenario under Condition C."""
